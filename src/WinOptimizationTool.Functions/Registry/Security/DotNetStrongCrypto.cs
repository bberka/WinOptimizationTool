...
public class DotNetStrongCrypto : BaseFunction
{
	public static Result Enable()
	{
		...
		{
			Result.Error("Not Implemented","Write-output \"Enabling .NET strong cryptography...\""),
		...
		return list.CombineAll("EnableDotNetStrongCrypto");
	}
	public static Result Disable()
	{
		var list = new List<Result>()
		{
			Result.Error("Not Implemented","Write-output \"Disabling .NET strong cryptography...\""),
		...
		return list.CombineAll("DisableDotNetStrongCrypto");
	}
}
