...
public class Telemetry : BaseFunction
{
    ...
    public Result Enable()
    {
        var list =  new List<Result>()
        {
            ...
            RegHelper.SetDword(RegistryHive.LocalMachine,
                "SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Policies\\DataCollection", "AllowTelemetry",
                3),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection",
                "AllowTelemetry"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\PreviewBuilds",
                "AllowBuildPreview"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine,
                "SOFTWARE\\Policies\\Microsoft\\Windows NT\\CurrentVersion\\Software Protection Platform",
                "NoGenTicket"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\SQMClient\\Windows",
                "CEIPEnable"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\AppCompat",
                "AITEnable"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\AppCompat",
                "DisableInventory"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\AppV\\CEIP", "CEIPEnable"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\TabletPC",
                "PreventHandwritingDataSharing"),
            RegHelper.DeleteValue(RegistryHive.LocalMachine,
                "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\TextInput", "AllowLinguisticDataCollection"),
    ...
    public Result Disable()
    {
        var list =  new List<Result>()
        {
            ...
            RegHelper.SetDword(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection", "AllowTelemetry", 0),
            RegHelper.SetDword(RegistryHive.LocalMachine, "SOFTWARE\\Policies\\Microsoft\\Windows\\PreviewBuilds", "AllowBuildPreview", 0),
